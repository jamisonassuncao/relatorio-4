...
\begin{figure}
  ...
  \subfloat[][Mapa do ângulo de mergulho da placa de Nazca.]{\includegraphics[width=0.83\columnwidth]{fig/slab2dip.png}\label{slab2dip}}

  \vspace{0.5cm}

  \subfloat[][Mapa da profundidade do topo da placa de Nazca.]{\includegraphics[width=0.83\columnwidth]{fig/slab2dep.png}\label{slab2dep}}
...
\begin{figure}
  ...
  \subfloat[][Tomografia do perfil A-A', de latitude $-8.0$ e longitudes de $-73.0$ à $-43.0$.]{\includegraphics[trim={2.5cm 9cm 2.5cm 0.25cm}, clip, width=0.40\columnwidth]{fig/profileA.png}\label{tomografiaPerfilA}}\hspace{0.5cm}
  \subfloat[][Tomografia do perfil B-B', de latitude $-18.0$ e longitudes de $-81.5$ à $-51.5$.]{\includegraphics[trim={2.5cm 9cm 2.5cm 0.25cm}, clip, width=0.40\columnwidth]{fig/profileB.png}\label{tomografiaPerfilB}}
